import { Box, Heading, Flex, Text, Grid, Tabs, Strong } from "@radix-ui/themes";
import {
  EnvelopeOpenIcon,
  CameraIcon,
  LockOpen1Icon,
        ...
        >
          <Flex direction="column" align="center" gap="2">
            ...
            <Text
              ...
              style={{ color: "grey" }}
            >
              No es algo que pasa una sola vez, sino que se mantiene en el
              tiempo.
            </Text>
          </Flex>
          <Flex direction="column" align="center" gap="2">
            ...
            <Text
              ...
              style={{ color: "grey" }}
            >
              Alguien lo hace a propósito para afectar a la otra persona.
            </Text>
          </Flex>
          <Flex direction="column" align="center" gap="2">
        ...
        >
          ...
          <Box pt="3">
            <Tabs.Content value="RRSS">
              <Flex gap={{ initial: "4", md: "5", lg: "7" }} direction="column">
                <Text
                  as="p"
                  color="gray"
                  size={{ initial: "3", lg: "4", xl: "5" }}
                >
                  ...
                  otro medio digital. Puede pasar de muchas formas, como:
                </Text>
                ...
                >
                  ...
                  estrés o tristeza. Esto puede afectar su vida diaria y la
                  forma en que se relaciona con los demás.
                </Text>
              </Flex>
            </Tabs.Content>
            <Tabs.Content value="fisico">
              <Flex gap={{ initial: "3", md: "5", lg: "7" }} direction="column">
                <Text
                  as="p"
                  color="gray"
                  size={{ initial: "3", lg: "4", xl: "5" }}
            ...
            <Tabs.Content value="psicologico">
              <Flex gap={{ initial: "3", md: "5", lg: "7" }} direction="column">
                ...
                >
                  ...
                  bienestar emocional. Puede suceder de muchas formas, como:
                </Text>
